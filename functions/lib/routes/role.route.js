...
// // Get a role by ID
router.get('/:roleId', role_controller_1.default.getRoleById);
// // Update a role
router.put('/:roleId', role_controller_1.default.updateRole);
// // Delete a role
router.delete('/:roleId', role_controller_1.default.deleteRole);
// Create a new role
